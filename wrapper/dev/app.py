...
class AsyncDownloader(AsyncFetcher):
    ...
    def get_list_async_params_from_batches(self):
        ...
        list_async_params = [{"contract":args
                            ,"params":list_params[idx] if len(list_params)>0 else {}
                            ,"method":self.method} 
    ...
    def prepare_contracts_from_list_args_params(self):
        ...
        for args_params in self.list_async_params:
            ...
            args["_async"] = True 
            option = Option(**args)
            contracts.append(option._get_method(**params))
        return contracts
...
class DownloadManager():
    ...
    def _get_list_dates_volatility(self):
        ...
        desired_strikes = option.get_desired_strikes()
...
if __name__=='__main__':
    ...
    for root in roots:
        ...
        for exp in desired_expirations:
            ...
            date_range = option._get_implied_vol_days_ago()
            if date_range:
